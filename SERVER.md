...
- Diablo 2, with LoD expansion (__NOT resurrected!__) installation
...
- __Confirm server is actually processing data__
  Change the below command to the correct folders and run it:  
  ...
  This will generate a tonne of output, but if it completes without error then your server is working.
