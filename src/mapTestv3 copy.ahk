...
playerPositionArray := []
playerPositionArray[0] := 6620
playerPositionArray[1] := 5690

imageUrl := "http://diab.wikiwarsgame.com:8080/v1/map/114773561/2/4/image?flat=true&trim=true"
...
; Gdip_FillRectangle(G, pBrush, 200, 200, 50, 50)
