        ...
        try {
            ...
            if (Instr(errMsg, "The operation timed out")) {
                ...
                If InStr(baseUrl, "map.d2r-mapview.xyz")
                    Msgbox, 48, d2r-mapview, Error downloading map image.`nPublic map server may be unavailable`nConsider running your own map server, it's easy to setup now and much faster`n`nCheck map server baseUrl in settings.ini or errors in log.txt`n`nExiting....
                Else
