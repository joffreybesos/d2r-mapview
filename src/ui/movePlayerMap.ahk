...
MovePlayerMap(ByRef settings, ByRef d2rprocess, ByRef pathAddress, ByRef mapHwnd1, ByRef unitHwnd1, ByRef mapImage, ByRef uiData) {
    ...
    , xPosDot := ((xPos - mapImage["mapOffsetX"]) * serverScale) + padding
    , yPosDot := ((yPos - mapImage["mapOffsetY"]) * serverScale) + padding
