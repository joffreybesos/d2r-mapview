...
formatStats(statArray) {
    ...
    for statName, statVal in statArray {
        switch (statName) {
            ...
            case "item_lightradius": statList[statArray["item_lightradius"].statOrder]:= Format("+{1} to Light Radius", statArray["item_lightradius"].statValue)
            ...
            case "item_armor_perlevel": statList[statArray["item_armor_perlevel"].statOrder]:= Format("+{1} Defense (Based on Character Level)", Round(statArray["item_armor_perlevel"].statValue) / 8)
            case "item_armorpercent_perlevel": statList[statArray["item_armorpercent_perlevel"].statOrder]:= Format("+{1}% Enhanced Defense (Based on Character Level)", statArray["item_armorpercent_perlevel"].statValue)
            case "item_hp_perlevel": statList[statArray["item_hp_perlevel"].statOrder]:= Format("+{1} to Life (Based on Character Level)", Round(statArray["item_hp_perlevel"].statValue) / 2048)
            case "item_mana_perlevel": statList[statArray["item_mana_perlevel"].statOrder]:= Format("+{1} to Mana (Based on Character Level)", Round(statArray["item_mana_perlevel"].statValue) / 2048)
            case "item_maxdamage_perlevel": statList[statArray["item_maxdamage_perlevel"].statOrder]:= Format("+{1} to Maximum Damage (Based on Character Level)", Round(statArray["item_maxdamage_perlevel"].statValue) / 8)
            case "item_maxdamage_percent_perlevel": statList[statArray["item_maxdamage_percent_perlevel"].statOrder]:= Format("+{1}% Enhanced Maximum Damage (Based on Character Level)", Round(statArray["item_maxdamage_percent_perlevel"].statValue) / 8)
            case "maxdamage": 
            ...
            case "item_strength_perlevel": statList[statArray["item_strength_perlevel"].statOrder]:= Format("+{1} to Strength (Based on Character Level)", Round(statArray["item_strength_perlevel"].statValue) / 8)
            case "item_dexterity_perlevel": statList[statArray["item_dexterity_perlevel"].statOrder]:= Format("+{1} to Dexterity (Based on Character Level)", Round(statArray["item_dexterity_perlevel"].statValue) / 8)
            case "item_vitality_perlevel": statList[statArray["item_vitality_perlevel"].statOrder]:= Format("+{1} to Vitality (Based on Character Level)", Round(statArray["item_vitality_perlevel"].statValue) / 8)
            case "item_tohit_perlevel": statList[statArray["item_tohit_perlevel"].statOrder]:= Format("+{1} to Attack Rating (Based on Character Level)", Round(statArray["item_tohit_perlevel"].statValue) / 8)
            case "item_tohitpercent_perlevel": statList[statArray["item_tohitpercent_perlevel"].statOrder]:= Format("{1}% Bonus to Attack Rating (Based on Character Level)", statArray["item_tohitpercent_perlevel"].statValue)
            case "item_resist_cold_perlevel": statList[statArray["item_resist_cold_perlevel"].statOrder]:= Format("Cold Resist +{1}% (Based on Character Level)", statArray["item_resist_cold_perlevel"].statValue)
            case "item_resist_fire_perlevel": statList[statArray["item_resist_fire_perlevel"].statOrder]:= Format("Fire Resist +{1}% (Based on Character Level)", statArray["item_resist_fire_perlevel"].statValue)
            case "item_resist_ltng_perlevel": statList[statArray["item_resist_ltng_perlevel"].statOrder]:= Format("Lightning Resist +{1}% (Based on Character Level)", statArray["item_resist_ltng_perlevel"].statValue)
            case "item_resist_pois_perlevel": statList[statArray["item_resist_pois_perlevel"].statOrder]:= Format("Poison Resist +{1}% (Based on Character Level)", statArray["item_resist_pois_perlevel"].statValue)
            case "item_absorb_cold_perlevel": statList[statArray["item_absorb_cold_perlevel"].statOrder]:= Format("Absorbs Cold Damage (Based on Character Level)", statArray["item_absorb_cold_perlevel"].statValue)
            case "item_absorb_fire_perlevel": statList[statArray["item_absorb_fire_perlevel"].statOrder]:= Format("Absorbs Fire Damage (Based on Character Level)", statArray["item_absorb_fire_perlevel"].statValue)
            case "item_thorns_perlevel": statList[statArray["item_thorns_perlevel"].statOrder]:= Format("Attacker Takes Damage of {1} (Based on Character Level)", statArray["item_thorns_perlevel"].statValue)
            case "item_find_gold_perlevel": statList[statArray["item_find_gold_perlevel"].statOrder]:= Format("{1}% Extra Gold from Monsters (Based on Character Level)", statArray["item_find_gold_perlevel"].statValue)
            case "item_find_magic_perlevel": statList[statArray["item_find_magic_perlevel"].statOrder]:= Format("{1}% Better Chance of Getting Magic Items (Based on Character Level)", statArray["item_find_magic_perlevel"].statValue)
            case "item_regenstamina_perlevel": statList[statArray["item_regenstamina_perlevel"].statOrder]:= Format("Heal Stamina Plus {1}% (Based on Character Level)", statArray["item_regenstamina_perlevel"].statValue)
            case "item_stamina_perlevel": statList[statArray["item_stamina_perlevel"].statOrder]:= Format("+{1} Maximum Stamina (Based on Character Level)", statArray["item_stamina_perlevel"].statValue)
            case "item_damage_demon_perlevel": statList[statArray["item_damage_demon_perlevel"].statOrder]:= Format("+{1}% Damage to Demons (Based on Character Level)", statArray["item_damage_demon_perlevel"].statValue)
            case "item_damage_undead_perlevel": statList[statArray["item_damage_undead_perlevel"].statOrder]:= Format("+{1}% Damage to Undead (Based on Character Level)", statArray["item_damage_undead_perlevel"].statValue)
            case "item_tohit_demon_perlevel": statList[statArray["item_tohit_demon_perlevel"].statOrder]:= Format("+{1} to Attack Rating against Demons (Based on Character Level)", statArray["item_tohit_demon_perlevel"].statValue)
            case "item_tohit_undead_perlevel": statList[statArray["item_tohit_undead_perlevel"].statOrder]:= Format("+{1} to Attack Rating against Undead (Based on Character Level)", Round(statArray["item_tohit_undead_perlevel"].statValue) / 2)
