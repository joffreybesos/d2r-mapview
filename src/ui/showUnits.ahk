            ...
            for each, missile in missilearray
            {
                ...
                if (oldMissilex = missilex && oldMissiley = missiley){
                    ...
                    switch (missile["UnitType"]){
                        ...
                        case "otherMissiles": Gdip_DrawEllipse(G, pPenOtherMissiles, missilex-3, missiley-3, majorDotSize, majorDotSize/2)
                        case "unknown": Gdip_DrawEllipse(G, pPenunknownMissiles, missilex-3, missiley-3, majorDotSize, majorDotSize/2)
                        ;default: Gdip_DrawEllipse(G, Gdip_CreatePen(settings["defaultMissleColor"], 1), missilex-3, missiley-3, majorDotSize, majorDotSize/2)
                    }
                }
